...
class ItemRepositoryTest {
    ...
    void shouldSaveItem() {
        ...
        item.setName("test");
        item = repository.save(item).block();
        assertNotNull(item);
    ...
    void shouldSaveItemLinks() {
        ItemEntity jettyItem = repository.save(ItemExample.JETTY01.toEntity()).block();
        ItemEntity pgItem = repository.save(ItemExample.POSTGRESQL01.toEntity()).block();
        ...
        jettyItem = repository.save(jettyItem).block();
