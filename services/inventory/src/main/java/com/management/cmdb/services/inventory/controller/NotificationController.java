...
import com.management.cmdb.services.inventory.service.NotificationService;
...
public class NotificationController {
    ...
    public Flux<ServerSentEvent<NotificationDto>> subscribeToNotifications() {
        LOGGER.info("Subscribing targetItemId global notifications");
    ...
    public Flux<ServerSentEvent<ItemDto>> subscribeToItemEvent() {
        LOGGER.info("Subscribing targetItemId item notifications");
        return Flux.create(sink -> {
