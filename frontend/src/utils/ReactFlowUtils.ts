...
function getParams(nodeA: InternalNode<Node>, nodeB: InternalNode<Node>): [x: number, y: number, position: Position] {
...
export function getEdgeParams(source: InternalNode<Node>, target: InternalNode<Node>): { sourceX: number; sourceY: number; targetX: number; targetY: number; sourcePosition: Position; targetPosition: Position } {
