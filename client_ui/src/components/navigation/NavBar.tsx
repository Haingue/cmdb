        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start rtl:justify-end">
            ...
            <Link to="/" className="flex ms-2 md:me-24">
              ...
              <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Cartography</span>
            </Link>
          </div>
          <div className="flex items-center">
            ...
            >
              <svg className={`w-5 h-5 ${dark && 'hidden'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
              ...
              style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate3d(265.5px, 60px, 0px)' }}
