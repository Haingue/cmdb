...
public class ItemTypeServiceImpl implements ItemTypeService {
    ...
    @Override
    @Tool(description = "Create new item type, first step to create new type of entities in the CMDB, the uuid will be generated by the tool so you can keep blank or omit it")
