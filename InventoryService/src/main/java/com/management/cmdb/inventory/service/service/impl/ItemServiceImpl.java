...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    @Tool(description = "Tool to create a new item in the CMDB, all uuid (identifiers) will be generated by the tool so don't send it in the json, be careful that the item type already exist in the CMDB .")
    ...
    @Override
    @Tool(description = "Tool to update an existing item in the CMDB")
    ...
    @Override
    @Tool(description = "Tool to find one specific item by its uuid")
