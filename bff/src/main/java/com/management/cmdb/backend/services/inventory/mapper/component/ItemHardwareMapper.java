...
public class ItemHardwareMapper implements ItemComponentMapper<Hardware> {

    public static final ItemHardwareMapper INSTANCE = new ItemHardwareMapper();

    private ItemHardwareMapper() {
    }

    @Override
    public Hardware mapToCoreModel(ItemDto itemDto) {
    ...
    @Override
    public ItemDto mapToItemDto(Hardware component) {
        ...
        if (location != null) {
            attributes.add(AttributeDto.builder().label("Location").value(location).build());
        }
