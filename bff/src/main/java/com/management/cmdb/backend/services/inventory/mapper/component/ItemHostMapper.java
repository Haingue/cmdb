...
public class ItemHostMapper implements ItemComponentMapper<Host> {

    public static final ItemHostMapper INSTANCE = new ItemHostMapper();

    private ItemHostMapper() {
    }

    @Override
    public Host mapToCoreModel(ItemDto itemDto) {
    ...
    @Override
    public ItemDto mapToItemDto(Host component) {
