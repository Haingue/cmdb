...
public interface EnvironmentInputPort extends CrudOperation<Environment, UUID> {
    ...
    Environment create (UUID projectUuid, String projectAbbreviation, String description, String location, EnvironmentType type, String jiraTracker, User initiator);
